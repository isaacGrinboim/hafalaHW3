...
@pytest.mark.parametrize("policy, threads, num_clients, queue_size, times, files",
                         [
                             ("block", 20, 5, 10, 20, LIGHT_FILES), #21 first fail
                             ("block", 16, 4, 32, 30, LIGHT2_FILES), #22 second fail
                             ("dh", 20, 5, 10, 20, LIGHT_FILES), #  23 first stuck
...
@pytest.mark.parametrize("policy, threads, num_clients, queue_size, times, files",
                        ...
                        #      ("random", 16, 12, 16, 20, EQUAL_FILES), #45
                          ])
